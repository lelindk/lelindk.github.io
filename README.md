# Portafolio Personal Responsive

Este proyecto creado es una página web adaptable a dispositivos de distintos tamaños (este tipo de sitio web se conoce en inglés como "responsive"). 
...
## Aclaraciones
Todo esto fue personalizado-modificado a partir de la plantilla proporcionada en el bootcamp Tecnolochicas PRO, proyecto de código HTML, CSS, JavaScript, Bootstrap 5 disponible en el repositorio: https://github.com/nancynsalazar/tecnolochicaspro_portafolio
